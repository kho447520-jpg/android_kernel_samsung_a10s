...
static int ili_spi_pll_clk_wakeup(void)
{
	int index = 0;
	u8 wdata[32] = {0};
	u8 wakeup[21] = {0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3, 0xA3};
...
int ili_interface_dev_init(struct ilitek_hwif_info *hwif)
{
	...
	ILI_INFO("ili_interface_dev_init   +++++++++1111+++++++:\n");
	...
	ILI_INFO("ili_interface_dev_init   +++++++++2222+++++++:\n");
